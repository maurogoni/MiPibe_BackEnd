...
exports.createUser = async function (_user) {
    ...
    try {
        ...
        if (_existEmail==null && _existUser==null){
            ...
            if (_existUser==null){
                console.log("======== El mail ya esta registrado con el siguiente Id ---->",_existEmail._id,"<----------- ==========")
                return 0;
            }else{
                console.log("======== Usuario no disponble, ya esta en uso. Id del usuario registrado: ---->",_existUser._id,"<----------- ==========")
                return 1;
            }
        }
...
exports.updateUser = async function (user) {
    ...
    if (!oldUser) {
        console.log("user.service.js -----> No se encontro el usuario para updatear.");
        return false;
    }
    ...
    try {
        console.log("user.service.js -----> Guardo el usuario en la base de datos.");
...
exports.deleteUser = async function (id) {
    ...
    if (_existID==null){
        console.log("user.service.js---deleteUser--> No se encontro usuario con ese ID:",id);
        return 0;
    }
    // Delete the User
    try {
