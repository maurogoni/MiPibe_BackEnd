...
exports.createProfile = async function (_profile) {
    ...
    var newProfile = new Profile({
        ...
        lastControl: _profile.lastControl,
    ...
    try {
        ...
        if (_existDNI==null){
            if (_existUser==null){
                console.log("======== Perfil no tiene usuario valido. Usuario no registrado: ---->",_existUser,"<----------- ==========")
                return 0; 
            }else{
                ...
                console.log("======== Perfil no disponble, ya esta en uso. DNI del usuario registrado: ---->",_existDNI,"<----------- ==========")
                return 1;            
        }
...
exports.updateProfile = async function (profile) {
    ...
    oldProfile.dateBorn = profile.dateBorn
    oldProfile.bloodType = profile.bloodType
    oldProfile.lastControl = profile.lastControl
    oldProfile.allergy = profile.allergy
